/*
Problem Spec: 
- Create a program that utilizes the nvGRAPH library. 
...
// Note, following provided nvgraph_PageRank.cpp example
...
W0 = {0.33, 0.50, 0.33, 0.50, 0.50, 1.00, 0.33, 0.50, 0.50, 1.00, 1.00, 1.00}
